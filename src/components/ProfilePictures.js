			...
			<div className="ui-block responsive-flex">
				<div className="ui-block-title">
					...
					<div className="block-btn align-right">
						<a href="#" data-toggle="modal" data-target="#create-photo-album" className="btn btn-primary btn-md-2">Create Album  +</a>

						<a href="#" data-toggle="modal" data-target="#update-header-photo" className="btn btn-md-2 btn-border-think custom-color c-grey">Add Photos</a>
					</div>

					<ul className="nav nav-tabs photo-gallery" role="tablist">
						<li className="nav-item">
							<a className="nav-link" data-toggle="tab" href="#photo-page" role="tab">
								{/*<svg className="olymp-photos-icon"><use xlink:href="svg-icons/sprites/icons.svg#olymp-photos-icon"></use></svg>*/}
							</a>
						</li>

						<li className="nav-item">
							<a className="nav-link active" data-toggle="tab" href="#album-page" role="tab">
